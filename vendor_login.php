...
<header>
    ...
    <div class="login-form">
                <h2>Vendor Login</h2> <!-- Updated heading -->
                <form action="vendor_valid.php" method="post" onsubmit="return validateForm()">
                ...
                <p>Don't have an account? <a href="vendor_register.php">Register here</a></p>
            </div>
        </div>
    </div>
    <footer class="footer">
